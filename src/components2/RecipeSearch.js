    ...
    return (
      ...
      <section className='m-0 w-full h-auto'>
        <form onSubmit={handleSubmit} className="flex justify-center h-auto pb-8 gap-4 bg-white rounded-lg">
          ...
          <input type="text" value={query} onChange={(e) => setQuery(e.target.value)} className="bg-green-50 hover:bg-green-200 rounded-lg p-2 mt-2 w-full border-4 border-yellow-500 text-gray-800 custom-scrollbar shadow-md" placeholder="search"/>
          ...
          <label className="text-gray-800 font block">
            ...
            <select value={health} onChange={(e) => setHealth(e.target.value)} className="bg-green-50 rounded-lg p-2 mt-2 w-full border-4 border-yellow-500 text-gray-800 appearance-none bg-no-repeat hover:bg-green-200 custom-scrollbar shadow-md">
