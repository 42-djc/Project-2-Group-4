        ...
        <div className='w-10/12'>
          {savedRecipes.map((recipe, index) => (
            <div className='flex flex-col items-center border-4 rounded-lg border-green-300 mt-4 pr-4 pl-4 w-full h-96 shadow-xl' key={index}>
              ...
              <a href={recipe.url} target="_blank" rel="noopener noreferrer" className='mt-2 w-40 rounded-md text-center font-semibold transition-colors bg-gradient-to-r from-green-300 to-green-600 hover:from-teal-800 hover:to-teal-400'>
                Go to the recipe!
              </a>
              <button
                className={`m-2 w-40 rounded-md font-semibold transition-colors bg-gradient-to-r from-red-600 to-red-800 hover:from-red-500 hover:to-orange-600 '}`}
